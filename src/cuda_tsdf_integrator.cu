...
constexpr float kDepthDiscontinuityBase = 0.012f;
constexpr float kDepthDiscontinuityRelative = 0.025f;
constexpr float kLayerMergeVoxelScale = 0.25f;
constexpr float kLayerNormalConsistencyCosine = 0.9f;
...
constexpr float kMinSurfaceConsistencyCosine = 0.9f;
